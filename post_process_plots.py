...
if __name__ == '__main__':
    ...
    h_0_str_mult_2 = './beta_xy=[0, 0.5]_d_X=3_d_Y=3_d_Z=50_n=10000_yz=0.5_beta_XZ=[0.0, 0.25, 0.25, 0.25, 0.25]'
    suffix = 'seeds=100_estimate=False_estimator=classifier_lr=0.0001_max_its=5000_width=512_layers=4_mixed=False_bs_ratio=0.01_kappa=10_val_rate=0.01_n_sample=250_criteria_limit=0.1_kill_counter=10_reg_lambda=0.01_alpha=0.5'
