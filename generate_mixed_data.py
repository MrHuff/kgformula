...
if __name__ == '__main__':
    ...
    for el in jobs:
        ...
        X_bin,Y_bin,Z_bin, w_bin = generate_simple_null(alp=0.5,new_dirname=data_dir,seed=el[5],d=1,n=el[1],null_case=null)
        X = torch.cat([X_cont,X_bin],dim=1)
        Y = torch.cat([Y_cont,Y_bin],dim=1)
