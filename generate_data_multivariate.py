...
if __name__ == '__main__':
        ...
        for d_Z in [50]:
            b_z = 1. #In higher dimensions, the take seems to be that one must be careful with how much dependence is created.
            ...
            for n in [100,1000,10000]:
                for beta_xy in [[0,b_y],[0,0]]:
                    data_dir = f'multivariate_1_K/beta_xy={beta_xy}_d_X={d_X}_d_Y={d_Y}_d_Z={d_Z}_n={n}_yz={yz}_beta_XZ={round(b_z/(d_Z**2),5)}_theta={theta}_phi={round(phi,2)}'
