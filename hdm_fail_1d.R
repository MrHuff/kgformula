...
for (beta_xy in xy_list){
  for (n in n_list){
    ...
    for (i in 0:99){
      t_file = sprintf("%s/beta_xy=[0, %s]_d_X=1_d_Y=1_d_Z=1_n=10000_yz=[0.5, 0.0]_beta_XZ=0.25_theta=2.0_phi=2.0/x_%s.csv",fold, beta_xy,i)
      y_file = sprintf("%s/beta_xy=[0, %s]_d_X=1_d_Y=1_d_Z=1_n=10000_yz=[0.5, 0.0]_beta_XZ=0.25_theta=2.0_phi=2.0/y_%s.csv",fold,beta_xy,i)
      z_file = sprintf("%s/beta_xy=[0, %s]_d_X=1_d_Y=1_d_Z=1_n=10000_yz=[0.5, 0.0]_beta_XZ=0.25_theta=2.0_phi=2.0/z_%s.csv",fold,beta_xy,i)
