...
if __name__ == '__main__':
    ...
    # generate_job_binary(n_list=[1000,5000,10000],net_layers=[2],net_width=[32],runs=1,seed_max=100,estimate=False,directory='do_null_binary_all_1d_real',job_type='kc_rule_new',dirname='')
