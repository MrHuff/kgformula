...
if __name__ == '__main__':
    ...
    jobs = []
    sanity=False
    for d_X,d_Y,d_Z, theta,phi in zip( [1],[1],[1],[5.0],[0.5]):
    # for d_X,d_Y,d_Z, theta,phi in zip( [1],[1],[1],[0.1],[0.9]):
        for b_z in [0.01]:  # ,1e-3,1e-2,0.05,0.1,0.25,0.5,1
            b_z = (d_Z ** 2) * b_z
            ...
            for n in [10000]:
                for beta_xy in [[xy_const, 0.0],[xy_const, 0.1],[xy_const, 0.2],[xy_const, 0.3],[xy_const, 0.4],[xy_const, 0.5]]:
