...
def return_file_name(a,b,perm,br,variant):

    _tmp = f'm={mode}_s={a}_{b}_e=False_est=NCE_sp=False_p={perm}_br={br}_v={variant}'
                ...
                for q in [0.8,0.6,0.4,0.2,0.1]:
                    for bootstrap_runs in [250]:
                        for variant in [1]:
                            ...
                            f_name=return_file_name(0,100,perm,bootstrap_runs,variant)
                            if histogram_true:
                            ...
                            if not macro_mode:
                                ...
                                for i in range(nr_of_gpus):
                                    ...
                                    suffices.append(return_file_name(a,b,perm,bootstrap_runs,variant))
                                ...
                                df_pval = pd.read_csv(PATH+f'fdf_m={mode}_s=0_100_e=False_est=NCE_sp=False_p={perm}_br={bootstrap_runs}_v={variant}.csv')
