...
if __name__ == '__main__':
    ...
    h_1_str_mult_2 = 'beta_xy=[0, 0.5]_d_X=3_d_Y=3_d_Z=3_n=1000_yz=0.5_beta_XZ=0.333'
    ...
    h_1_str_mult_2_big = 'beta_xy=[0, 0.5]_d_X=3_d_Y=3_d_Z=50_n=1000_yz=0.5_beta_XZ=0.02'
    ...
    for h,seeds in zip([h_0_str_mult_2,h_1_str_mult_2],[1000,1000]):
        args={
            'data_dir': h,
            'estimate':False,
            'debug_plot':False,
