...
if __name__ == '__main__':
    ...
    h_0_str_mult_2 = 'beta_xy=[0, 0.0]_d_Z=3_n=1000_yz=0.5_beta_XZ=[0.0, 0.25, 0.25, 0.25]'
    h_1_str_mult_2 = 'beta_xy=[0, 0.5]_d_Z=3_n=1000_yz=0.5_beta_XZ=[0.0, 0.25, 0.25, 0.25]'
    args={
