...
if __name__ == '__main__':
    ...
    h_0_str_mult_2 = 'beta_xy=[0, 0.0]_d_X=3_d_Y=3_d_Z=3_n=1000_yz=0.5_beta_XZ=[0.0, 0.3333333333333333, 0.3333333333333333, 0.3333333333333333]'
    h_1_str_mult_2 = 'beta_xy=[0, 0.5]_d_X=3_d_Y=3_d_Z=3_n=1000_yz=0.5_beta_XZ=[0.0, 0.3333333333333333, 0.3333333333333333, 0.3333333333333333]'
    ...
    h_0_str_mult_2_big = 'beta_xy=[0, 0.0]_d_X=3_d_Y=3_d_Z=50_n=1000_yz=0.5_beta_XZ=[0.0, 0.02, 0.02, 0.02, 0.02]'
    h_1_str_mult_2_big = 'beta_xy=[0, 0.5]_d_X=3_d_Y=3_d_Z=50_n=1000_yz=0.5_beta_XZ=[0.0, 0.02, 0.02, 0.02, 0.02]'
